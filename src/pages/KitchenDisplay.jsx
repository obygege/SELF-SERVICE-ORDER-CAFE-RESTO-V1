    ...
    return (
        <div className="min-h-screen bg-slate-50 p-4 font-sans pb-20">
            <style>
                {`
                @media screen {
                    #kitchen-print-receipt { display: none; }
                }
                @media print {
                    @page { 
                        size: 58mm auto; 
                    ...
                    #kitchen-print-receipt, #kitchen-print-receipt * { 
                        visibility: visible; 
                        color: #000 !important;
            ...
            <div id="kitchen-print-receipt" className="bg-white text-black font-mono">
                {selectedOrder && (
                    <div className="flex flex-col w-full text-center">
                        <div style={{ borderBottom: '2px solid black', paddingBottom: '2mm', marginBottom: '2mm' }}>
                            <h2 style={{ fontSize: '12px', fontWeight: '900', margin: '0', textTransform: 'uppercase' }}>Dapur (Food)</h2>
                        ...
                        <div style={{ textAlign: 'center', marginTop: '3mm', fontSize: '9px', borderTop: '2px solid black', paddingTop: '2mm', fontWeight: '900' }}>
                            <p style={{ margin: '0' }}>PESANAN MAKANAN</p>
