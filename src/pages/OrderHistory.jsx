...
const OrderHistory = () => {
    ...
    useEffect(() => {
        ...
        // Live Listener menggunakan onSnapshot
        const q = query(
    ...
    const handleReupload = async (orderId) => {
        ...
        try {
            await updateDoc(doc(db, "orders", orderId), {
                ...
                note: 'Bukti pembayaran diperbarui oleh pelanggan.'
            });
            toast.success("Berhasil dikirim ulang!");
    ...
    const getStatusInfo = (status, paymentStatus) => {
        ...
        if (paymentStatus === 'paid') {
            switch (status) {
                case 'pending': return { label: 'ANTREAN DAPUR', color: 'bg-green-600 text-white', icon: <Clock size={14} /> };
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="space-y-3 mb-6 bg-slate-50 p-4 rounded-3xl border border-slate-100 border-dashed">
                                        ...
                                        <div className="pt-3 border-t border-slate-200 mt-2 flex justify-between items-center font-black">
                                            <span className="text-[10px] text-slate-400 uppercase tracking-widest">Total Tagihan</span>
                                    ...
                                    <div className="mt-4 flex justify-between items-center px-2 text-gray-400">
                                        <div className="flex items-center gap-2">
                                            <Clock size={12} />
                                        ...
                                        <span className="text-[8px] font-black uppercase tracking-widest italic">{order.paymentMethod}</span>
                                    </div>
                                </div>
                            </div>
                        );
