...
const OrderHistory = () => {
    ...
    const handleReupload = async (orderId) => {
        ...
        try {
            await updateDoc(doc(db, "orders", orderId), {
                ...
                note: 'Bukti diperbarui pelanggan.'
            });
    ...
    const getStatusInfo = (status, paymentStatus) => {
        ...
        if (paymentStatus === 'paid') {
            switch (status) {
                case 'pending': return { label: 'ANTREAN', color: 'bg-green-600 text-white', icon: <Clock size={14} /> };
    ...
    if (fetching && orders.length === 0) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 flex-col gap-3">
                ...
                <p className="text-gray-400 text-[10px] font-black uppercase tracking-[0.2em]">Memuat Data...</p>
            </div>
        );
    }
            ...
            <div className="p-4 space-y-4">
                {orders.length === 0 ? (
                    <div className="text-center py-20 flex flex-col items-center">
                        ...
                        <p className="text-gray-400 font-black text-[10px] uppercase tracking-widest">Belum ada riwayat</p>
