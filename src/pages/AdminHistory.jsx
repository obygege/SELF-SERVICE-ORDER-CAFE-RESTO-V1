...
const AdminHistory = () => {
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Yakin hapus riwayat ini permanen?")) {
    ...
    const filteredOrders = orders.filter(o => {
        const idMatch = (o.orderId || '').toLowerCase().includes(searchTerm.toLowerCase());
        ...
        <div>
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
                    <History className="text-orange-600" /> Riwayat Transaksi Selesai
                </h1>
                <div className="relative">
                    ...
                    <input
                        ...
                        className="pl-10 pr-4 py-2 border rounded-xl focus:ring-2 focus:ring-orange-500 outline-none w-64"
                        value={searchTerm}
                            ...
                            <tr key={order.id} className="hover:bg-gray-50 text-sm">
                                ...
                                <td className="p-4">
                                    <div className="font-bold flex items-center gap-1">
                                        <User size={14} className="text-gray-400" /> {order.customerName || 'Guest'}
                                    </div>
                                ...
                                <td className="p-4 text-center">
                                    <button onClick={() => handleDelete(order.id)} className="text-red-500 hover:bg-red-50 p-2 rounded transition">
                                        <Trash2 size={18} />
                                    </button>
                                </td>
                            </tr>
